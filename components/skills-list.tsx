...
const CategoryIcons: Record<string, React.ReactElement> = {
  ...
  "Embedded Systems": <MicrochipIcon className="size-6" />,
  "Other Skills": <ListIcon className="size-6" />,
};
...
const SkillsList = () => {
  const skills = {
    "Web Development": [
      ...
      "Designing and integrating scalable APIs & databases",
      "Developing secure, high-performance web platforms",
      "Creating modern, responsive, and user-friendly designs",
    ],
    "Embedded Systems": [
      "C/C++ programming for microcontrollers",
      "Arduino & ESP32 (ESP-IDF) development",
      "IoT systems, sensors, and real-time integration",
    ],
    "Other Skills": [
      "UI/UX design with Figma and Photoshop",
      "Database design and local DB implementation",
      "Mobile development with Expo.js (React Native)",
    ],
  };

  return (
    <div className="text-left h-full w-full border-r min-h-full">
      <h3 className="text-foreground text-3xl md:text-4xl font-semibold sm:my-4 p-4 md:p-0 md:pl-3 uppercase">
        What I do?
      </h3>
